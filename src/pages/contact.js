...
const links = [
  {
    label: 'ruebena.dawes@ndm.ox.ac.uk',
    href: 'mailto:ruebena.dawes@ndm.ox.ac.uk',
    sub: 'University of Oxford',
    Icon: Mail,
  },
  {
    label: 'r.dawes@garvan.org.au',
    href: 'mailto:r.dawes@garvan.org.au',
    sub: 'Garvan Institute of Medical Research',
    Icon: Mail,
  },
  {
    label: 'Bluesky',
    ...
    <Layout>
      ...
      <section className="text-gray-700">
        ...
        <p className="mb-8 text-gray-600">
          I am always happy to discuss potential collaborations, research questions, or speaking opportunities.
        </p>
        <ul className="space-y-5">
          {links.map(({ label, href, sub, Icon }) => (
            <li key={href}>
              <a href={href} target={href.startsWith('mailto') ? undefined : '_blank'} rel="noreferrer" className="flex items-center gap-3 group">
